...
The media fixtures and runtime binaries are not redistributed. See [MEDIA.md](../tests/harness/MEDIA.md) for the exact upstream video, hash and setup. The earlier unused MP4 is omitted as well. User profiles, login configuration, credentials, machine-wide settings and process/service diagnostic inventories are not included.
